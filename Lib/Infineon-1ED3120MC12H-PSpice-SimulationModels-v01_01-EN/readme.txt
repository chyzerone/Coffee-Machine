##########################################################################################
## Simulation model of 1ED3120MC12H Level 1 for SIMetrix version 8.3g or higher
##########################################################################################
...
VER    | BY                       | DATE          | OBS                         
--------------------------------------------------------------------------------
01.00  | AA                       | 2020-07-31    | created    (*1)
--------------------------------------------------------------------------------
01.01  | AA                       | 2022-04-28    | model update
--------------------------------------------------------------------------------
...
The delivery package contains the following:
	...
	\Model\1ED3120MC12H.lib                : model lib file
	\Model\1ED3120MC12H.sxslb              : schematic symbol for the lib
	\Model\DEMO_TESTBENCH.sxsch            : demo testbench provided together with the model 
	\Model\IGBT_1200V_HighSpeed3_L1.lib    : Infineon's IGBT model
	\Model\IGBT_1200V_HighSpeed3_L1.sxslb  : Infineon's IGBT symbol for schematic
